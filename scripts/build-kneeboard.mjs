...
const pages = [
  ...
  {
    file: '07-MFD3-LANTIRN', title: 'MFD 3 • LANTIRN', kicker: 'TARGETING-POD CONTROLS',
    items: [
      item('BTN 1', 'Video output TCS / LANTIRN'), item('BTN 2', 'Power toggle'),
      item('BTN 3', 'OPER / STBY unstow'), item('BTN 4', 'Mode toggle'),
      item('BTN 5', 'Laser arm toggle'), item('BTN 6', 'Laser latched'),
      item('BTN 7', 'Trigger half action'), item('BTN 8', 'Trigger full action', 'red'),
      item('BTN 9', 'Undesignate'), item('BTN 10', 'Toggle FOV'),
      item('BTN 11', 'Slew up'), item('BTN 12', 'Slew right'),
      item('BTN 13', 'Slew down'), item('BTN 14', 'Slew left'),
      item('BTN 15', 'Point track'), item('BTN 16', 'Area track'),
      item('BTN 17', 'Toggle WHOT / BHOT'), item('BTN 18', 'QWP−'),
      item('BTN 19', 'QWP+'), item('BTN 20', 'S4 press • declutter / lase / MGC'),
      item('BTN 21', 'S4 up • QADL / QHUD / code / gain'), item('BTN 22', 'S4 right • QDES / digit / level'),
      item('BTN 23', 'S4 down • QSNO / code / gain'), item('BTN 24', 'S4 left • digit / level'),
      item('BTN 25', 'Slider AGC / MGC'), item('BTN 26', 'Slider laser / focus'),
      item('BTN 27', 'Power POD'), item('BTN 28', 'Power OFF'),
    ],
  },
  {
